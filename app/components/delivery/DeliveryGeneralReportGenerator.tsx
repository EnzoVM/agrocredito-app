...
import DeliveryGenenalDocument from './DeliveryGeneralDocument'

export default function DeliveryGeneralReportGenerator ({ campaignId }: { campaignId: string }) {
  ...
  return (
    <>
      {
        finishLoadPDFData
          ? <PDFDownloadLink onClick={getMinutesAndRegisterNewLog} document={<DeliveryGenenalDocument deliveries={deliveries} campaignId={campaignId}/>} fileName={`entregas_${campaignId}.pdf`} >
              <Button
