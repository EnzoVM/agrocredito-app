...
export default function CreditRequestGeneralReportGenerator ({ campaignId }: { campaignId: string }) {
  ...
  return (
    <>
      {
        finishLoadPDFData
          ? <PDFDownloadLink onClick={getMinutesAndRegisterNewLog} document={<CreditRequestGeneralDocument creditRequests={creditRequestsReport} campaignId={campaignId}/>} fileName={`peticiones_de_credito_${campaignId}.pdf`} >
              <Button
