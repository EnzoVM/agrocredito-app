...
import AccountStatusDocument from './AccountSatusDocument'

export default function AccountSatusReportGenerator ({ creditRequestId }: { creditRequestId: string }) {
  ...
  const [finishLoadPDFData, setFinishLoadPDFData] = useState(false)
  ...
  return (
    <>
      {
        finishLoadPDFData
          ? <PDFDownloadLink onClick={getMinutesAndRegisterNewLog} document={<AccountStatusDocument accountStatus={accountStateData}/>} fileName={`estado_de_cuenta_${accountStateData.campaignId}_${accountStateData.creditRequesId}_${accountStateData.farmerData.farmerId}.pdf`} >
              <Button
          ...
          : <Button
            ...
            >
              ...
              Preparando generador de reporte...
            </Button>
      }
    </>
