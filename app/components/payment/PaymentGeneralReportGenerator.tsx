...
import PaymentGeneralDocument from './PaymentGeneralDocument'
import { listPaymentsService } from '@/services/payment.service'

export default function PaymentGeneralReportGenerator ({ campaignId }: { campaignId: string }) {
  ...
  return (
    <>
      {
        finishLoadPDFData
          ? <PDFDownloadLink onClick={getMinutesAndRegisterNewLog} document={<PaymentGeneralDocument payments={payments} campaignId={campaignId}/>} fileName={`abonos_${campaignId}.pdf`} >
              <Button
