...
export default function DeleteFarmerModal ({ modalDeleteCampaignIsOpen, setModalDeleteCampaignIsOpen, campaignId, setFilters, setPaginationSelected, setPaginationNumbers }: Props) {
