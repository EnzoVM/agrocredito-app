      ...
      <Modal show={modalDeleteCampaignIsOpen} onClose={() => setModalDeleteCampaignIsOpen(false)}>
        <Modal.Body className="bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-6 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Está seguro de que desea eliminar el proyecto: {projectDeleted.projectDescription}?</h3>
              <button
